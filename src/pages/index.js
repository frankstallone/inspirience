  ...
  return (
    <>
      ...
      <header className="p-6 sm:px-24 md:px-40 xl:px-80 min-h-screen bg-gradient-to-br from-yellow-300 to-pink-600 flex flex-col flex-1 justify-center items-center">
        <h1 className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl tracking-wider md:font-thin mix-blend-overlay">
          Inspirience
        </h1>
      </header>
      <figure className="p-6 sm:px-24 md:px-40 xl:px-80 min-h-screen bg-gradient-to-tr from-blue-300 to-green-600 flex flex-col flex-1 justify-center items-center">
        <blockquote className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl tracking-wider md:font-thin mix-blend-overlay">
      ...
      <figure className="p-6 sm:px-24 md:px-40 xl:px-80 min-h-screen bg-gradient-to-bl from-yellow-200 via-yellow-400 to-yellow-700 flex flex-col flex-1 justify-center items-center">
        <blockquote className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl tracking-wider md:font-thin mix-blend-overlay">
      ...
      <figure className="p-6 sm:px-24 md:px-40 xl:px-80 min-h-screen bg-gradient-to-tr from-pink-300 via-purple-300 to-indigo-400 flex flex-col flex-1 justify-center items-center">
        <blockquote className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl tracking-wider md:font-thin mix-blend-overlay">
